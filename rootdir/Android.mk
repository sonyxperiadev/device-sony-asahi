...
LOCAL_SRC_FILES := vendor/etc/fstab.asahi
...
include $(CLEAR_VARS)
LOCAL_MODULE := init.asahi
LOCAL_SRC_FILES := vendor/etc/init/init.asahi.rc
LOCAL_MODULE_TAGS := optional
...
include $(CLEAR_VARS)
LOCAL_MODULE := init.asahi.pwr
LOCAL_SRC_FILES := vendor/etc/init/init.asahi.pwr.rc
LOCAL_MODULE_TAGS := optional
LOCAL_MODULE_SUFFIX := .rc
LOCAL_MODULE_CLASS := ETC
LOCAL_MODULE_PATH := $(TARGET_OUT_VENDOR_ETC)/init
